...
darksky_api_key = ENTER API KEY HERE
...
#LOW_TEMP
low_temp = today["temperatureHigh"]
...
response = requests.post(
        ...
        auth=("api", ENTER API KEY HERE),
        files=[("attachment", ("today_hourly_weather.csv", open("C:/Users/Weihua/Documents/Columbia_Summer/foundations/06-18-18/today_hourly_weather.csv","rb").read()))],
